...
var LastOpenedFiles = preload("res://addons/FKEditor_FileEditor/Scripts/EditorConfig.gd").new()
...
# ------------------------------------------------------------------------------
func load_icons():
	$VBoxContainer/HSplitContainer/VBoxContainer/HBoxContainer/sections_icon.texture = \
		IconLoader.load_icon_from_name("sections")
	$VBoxContainer/HSplitContainer/VBoxContainer2/HBoxContainer2/keys_icon.texture = \
		IconLoader.load_icon_from_name("keys")
...
func new_section():
	...
	if section_name and key_name and key_value:
		...
		print("Section <",section_name,"> with Key name: <",key_name, \
			"> and Key value: <",key_value,"> not valid.")
# ------------------------------------------------------------------------------
func remove_section():
		var file = ConfigFile.new()
		file.load(current_file_path)
...
func edit_key():
	...
	new_key()
# ------------------------------------------------------------------------------
# load a section with custom fields @section_name = name of section ; 
# @section_metadata = keys of this section with keys' properties
