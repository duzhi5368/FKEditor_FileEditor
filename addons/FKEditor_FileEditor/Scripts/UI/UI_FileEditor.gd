...
var Preview = preload("res://addons/FKEditor_FileEditor/Scenes/Preview.tscn")
var IniEditor = preload("res://addons/FKEditor_FileEditor/Scenes/IniEditor.tscn")
var VanillaEditor = preload("res://addons/FKEditor_FileEditor/Scenes/VanillaEditor.tscn")
var CsvEditor = preload("res://addons/FKEditor_FileEditor/Scenes/CSVEditor.tscn")
...
func update_version():
	...
	var err = config.load("res://addons/FKEditor_FileEditor/plugin.cfg")
	if err == OK:
